...
constexpr size_t VALIDATORS_TREE_HEIGHT_BEACON = 17;
constexpr size_t VALIDATORS_MAX_COUNT_BEACON = 1 << VALIDATORS_TREE_HEIGHT_BEACON;

constexpr size_t VALIDATORS_TREE_HEIGHT_POSEIDON = 17;
    ...
    [[private_input]] uint64_t_be epoch)
{
  ...
  */
  ...
  std::array<field_type, 131072> layer0;
