...
#pragma zk_multi_prover 0
  {
    ...
    layer1[0] = evaluate_root<16384>(layer0_begin, layer0_begin + 16384, 16384);
  }
...
#pragma zk_multi_prover 1
  {
    ...
    layer1[1] = evaluate_root<16384>(layer0_begin + 16384, layer0_begin + 16384, 16384);
  }
...
#pragma zk_multi_prover 2
  {
    ...
    layer1[2] = evaluate_root<16384>(layer0_begin + 16384 * 2, layer0_begin + 16384 * 3, 16384);
  }
...
#pragma zk_multi_prover 3
  {
    ...
    layer1[3] = evaluate_root<16384>(layer0_begin + 16384 * 3, layer0_begin + 16384 * 4, 16384);
  }
...
#pragma zk_multi_prover 4
  {
    ...
    layer1[4] = evaluate_root<16384>(layer0_begin + 16384 * 4, layer0_begin + 16384 * 5, 16384);
  }
...
#pragma zk_multi_prover 5
  {
    ...
    layer1[5] = evaluate_root<16384>(layer0_begin + 16384 * 5, layer0_begin + 16384 * 6, 16384);
  }
...
#pragma zk_multi_prover 6
  {
    ...
    layer1[6] = evaluate_root<16384>(layer0_begin + 16384 * 6, layer0_begin + 16384 * 7, 16384);
  }
...
#pragma zk_multi_prover 7
  {
    ...
    layer1[7] = evaluate_root<16384>(layer0_begin + 16384 * 7, layer0_begin + 16384 * 8, 16384);
  }
